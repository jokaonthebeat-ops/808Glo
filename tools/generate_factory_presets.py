...
RECIPES: "OrderedDict[str, list[dict[str, Any]]]" = OrderedDict(
    [
        ...
        ("Distorted", [
            ...
            R("Burn Notice", "A warm asymmetrical burn with a longer musical tail.", ["warm", "asymmetrical"], voiceMode=0, legato=True, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=105, body=0.5927, harmonics=0.8274, harmonicBalance=-0.907, pitchDrop=6.8, pitchDecay=52.8, pitchCurve=0.8, attack=0.1048, hold=0, decay=838.4, sustain=0.0508, release=190, ampCurve=0.7133, click=0.3054, clickTone=4783.0189, clickDecay=3.7, punch=0.0592, tone=5382.9787, toneKeytrack=0.22, drive=24.3, driveMode=2, compressor=0.4085, clipper=0.3588, output=-5.1),
        ...
        ("West Coast", [
            R("Palm Bounce", "A warm round coastal 808 with an easy medium glide.", ["round", "easy-glide"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=122, body=0.1336, harmonics=0.3294, harmonicBalance=0.4189, pitchDrop=6.15, pitchDecay=89.8887, pitchCurve=1.3, attack=0.4831, hold=0, decay=2821.9732, sustain=0.3259, release=390, ampCurve=0.9518, click=0.1609, clickTone=3869.4199, clickDecay=4.5, punch=0.1625, tone=3349.9972, toneKeytrack=0.26, drive=1.99, driveMode=1, compressor=0.2629, clipper=0.1921, output=-6.14),
            ...
            R("Hydraulic Drop", "A pronounced downward drop with a springy hydraulic tail.", ["drop", "springy"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=142, body=0.0416, harmonics=0.1932, harmonicBalance=0.2877, pitchDrop=8.8, pitchDecay=64.4, pitchCurve=0.72, attack=0.4909, hold=0, decay=1288.1, sustain=0.2165, release=170, ampCurve=0.6068, click=0.1736, clickTone=3432.8882, clickDecay=4.5, punch=0.1121, tone=3654.9725, toneKeytrack=0.26, drive=7.75, driveMode=2, compressor=0.2629, clipper=0.201, output=-4.72),

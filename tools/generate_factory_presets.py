...
RECIPES: "OrderedDict[str, list[dict[str, Any]]]" = OrderedDict(
    [
        ("Clean & Sub", [
            R("Pure Current", "A pure sine-led foundation with a deep, even tail.", ["pure", "long"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.1393, harmonics=0.0565, harmonicBalance=0.3055, pitchDrop=10.18, pitchDecay=77.8717, pitchCurve=1.15, attack=0.1209, hold=0, decay=1243.5, sustain=0.0781, release=220, ampCurve=0.5801, click=0.0798, clickTone=3073.4676, clickDecay=2.8, punch=0.071, tone=2408.7577, toneKeytrack=0.05, drive=0.89, driveMode=0, compressor=0.0976, clipper=0.008, output=1.77),
            R("Deep Water", "A soft slow-blooming sub for sparse arrangements.", ["soft", "deep"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0253, harmonics=0.0379, harmonicBalance=0.1855, pitchDrop=15.82, pitchDecay=51.8, pitchCurve=1.15, attack=0.1048, hold=0, decay=1412.1613, sustain=0.1097, release=460, ampCurve=0.8982, click=0.1298, clickTone=3449.8388, clickDecay=2.8, punch=0.0203, tone=3172.7111, toneKeytrack=0.05, drive=1.55, driveMode=0, compressor=0.0818, clipper=0.0302, output=1.05),
            R("Night Foundation", "A round clean 808 with a firmer front edge.", ["round", "firm"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0815, harmonics=0.055, harmonicBalance=0.2078, pitchDrop=8.75, pitchDecay=63.8758, pitchCurve=0.72, attack=0.3073, hold=0, decay=3047.8, sustain=0.3486, release=220, ampCurve=0.5334, click=0.0735, clickTone=3430.9122, clickDecay=2.8, punch=0.0382, tone=3134.2942, toneKeytrack=0.05, drive=0.38, driveMode=0, compressor=0.0405, clipper=0.0062, output=-2.87),
            ...
            R("Round Table", "A rounded triangle blend with restrained tape color.", ["rounded", "tape"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0176, harmonics=0.0455, harmonicBalance=0.1328, pitchDrop=14.82, pitchDecay=60.5, pitchCurve=1.15, attack=0.1871, hold=0, decay=3096.8288, sustain=0.2276, release=220, ampCurve=0.8641, click=0.1098, clickTone=3357.4152, clickDecay=2.8, punch=0.1244, tone=2985.111, toneKeytrack=0.05, drive=1.29, driveMode=1, compressor=0.0545, clipper=0.0136, output=-2.12),
            R("Mono Gravity", "A weighty mono sub with a subtle playable slide.", ["weighty", "slide"], voiceMode=0, legato=True, triggerMode=1, velocitySens=48, tune=0, fine=0, bendRange=12, glide=82, body=0.1711, harmonics=0.0514, harmonicBalance=0.2944, pitchDrop=9.3, pitchDecay=65.4919, pitchCurve=0.62, attack=0.2949, hold=0, decay=1217.2, sustain=0.0547, release=360, ampCurve=0.8031, click=0.097, clickTone=3036.7191, clickDecay=2.8, punch=0.0597, tone=2334.166, toneKeytrack=0.05, drive=1.17, driveMode=0, compressor=0.0716, clipper=0.026, output=2.12),
            R("Clean Sweep", "A clean high-impact drop that settles into an uncluttered sub.", ["impact", "clean"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0754, harmonics=0.0036, harmonicBalance=0.2382, pitchDrop=7.87, pitchDecay=66.3, pitchCurve=0.48, attack=0.2419, hold=0, decay=1696.6626, sustain=0.32, release=75, ampCurve=1.1213, click=0.1049, clickTone=2869.6941, clickDecay=2.8, punch=0.089, tone=2900.7368, toneKeytrack=0.05, drive=0.33, driveMode=0, compressor=0.0524, clipper=0.0225, output=1.79),
            R("Ocean Floor", "A huge slow sub tail designed for open half-time patterns.", ["huge", "half-time"], voiceMode=0, legato=True, triggerMode=1, velocitySens=48, tune=0, fine=0, bendRange=12, glide=155, body=0.042, harmonics=0.0126, harmonicBalance=0.2809, pitchDrop=13.7, pitchDecay=77.5678, pitchCurve=1.8, attack=0.0908, hold=0, decay=1150, sustain=0.1814, release=980, ampCurve=1.1822, click=0.082, clickTone=3179.2453, clickDecay=2.8, punch=0.0849, tone=3622.5028, toneKeytrack=0.05, drive=1.5, driveMode=0, compressor=0.0601, clipper=0.0213, output=0.96),
            R("Fundamental One", "A reliable fundamental-first 808 for general production.", ["balanced", "utility"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0253, harmonics=0.017, harmonicBalance=0.2757, pitchDrop=8.66, pitchDecay=70.0276, pitchCurve=1.15, attack=0.2968, hold=0, decay=1454.8, sustain=0.1029, release=210, ampCurve=0.4387, click=0.1205, clickTone=3433.1338, clickDecay=2.8, punch=0.1145, tone=3178.7234, toneKeytrack=0.05, drive=0.54, driveMode=0, compressor=0.0639, clipper=0.0228, output=2.19),
            R("Subtle Giant", "A broad clean body with just enough harmonic translation.", ["broad", "translation"], voiceMode=0, legato=False, triggerMode=0, velocitySens=48, tune=0, fine=0, bendRange=12, glide=0, body=0.0354, harmonics=0.0383, harmonicBalance=0.1291, pitchDrop=15.2, pitchDecay=75, pitchCurve=1.15, attack=0.2136, hold=0, decay=1800, sustain=0.0495, release=520, ampCurve=0.7259, click=0.1176, clickTone=3061.2181, clickDecay=2.8, punch=0.1219, tone=2607.6686, toneKeytrack=0.05, drive=0.2, driveMode=0, compressor=0.0706, clipper=0.0323, output=1.15),
            ...
            R("Low Meridian", "A stable tonal sub with gentle key tracking for melodic basslines.", ["tonal", "melodic"], voiceMode=1, legato=False, triggerMode=1, velocitySens=42, tune=0, fine=0, bendRange=12, glide=0, body=0.0136, harmonics=0.0269, harmonicBalance=0.3319, pitchDrop=10.95, pitchDecay=80.8, pitchCurve=0.4, attack=0.379, hold=0, decay=1475, sustain=0.1528, release=620, ampCurve=0.5304, click=0.1441, clickTone=3518.8679, clickDecay=2.8, punch=0.1526, tone=3638.2979, toneKeytrack=0.48, drive=1.57, driveMode=0, compressor=0.1035, clipper=0.0036, output=9.36),
        ]),
        ("Trap", [
            ...
            R("Midnight Flex", "A deep smooth trap 808 made for long held notes.", ["smooth", "held"], voiceMode=0, legato=True, triggerMode=1, velocitySens=62, tune=0, fine=0, bendRange=12, glide=320, body=0.1381, harmonics=0.2762, harmonicBalance=-0.7158, pitchDrop=18.5, pitchDecay=69.8925, pitchCurve=1.7, attack=0.3977, hold=0, decay=816.7, sustain=0.1888, release=560, ampCurve=0.4511, click=0.3357, clickTone=6128.1315, clickDecay=3, punch=0.2052, tone=7563.0465, toneKeytrack=0.16, drive=2.48, driveMode=1, compressor=0.2676, clipper=0.1742, output=-1.42),
            R("Heavy Motion", "A balanced trap workhorse with hard punch and usable glide.", ["workhorse", "punchy"], voiceMode=0, legato=True, triggerMode=0, velocitySens=62, tune=0, fine=0, bendRange=12, glide=150, body=0.0405, harmonics=0.3493, harmonicBalance=-0.7148, pitchDrop=16.73, pitchDecay=65.18, pitchCurve=0.52, attack=0.3299, hold=0, decay=1650, sustain=0.0496, release=95, ampCurve=0.4297, click=0.4722, clickTone=5920.2481, clickDecay=3, punch=0.228, tone=7268.146, toneKeytrack=0.16, drive=6.54, driveMode=2, compressor=0.3859, clipper=0.1377, output=-2.84),
            ...
            R("Trunk Ritual", "A slow dirty trunk rumbler with a wide tonal footprint.", ["rumble", "dirty"], voiceMode=0, legato=True, triggerMode=1, velocitySens=62, tune=0, fine=0, bendRange=12, glide=285, body=0.2188, harmonics=0.42, harmonicBalance=-0.584, pitchDrop=24, pitchDecay=70.8, pitchCurve=2, attack=0.3242, hold=0, decay=1395.05, sustain=0.3147, release=690, ampCurve=0.8978, click=0.4297, clickTone=5505.2795, clickDecay=3, punch=0.2961, tone=7521.2766, toneKeytrack=0.16, drive=2.5, driveMode=1, compressor=0.3547, clipper=0.2491, output=-4.46),
            ...
            R("Dead Center", "A mono-solid trap fundamental with no wasted upper fizz.", ["mono", "focused"], voiceMode=0, legato=False, triggerMode=0, velocitySens=62, tune=0, fine=0, bendRange=12, glide=0, body=0.1855, harmonics=0.3493, harmonicBalance=-0.4851, pitchDrop=28, pitchDecay=78.3, pitchCurve=0.75, attack=0.4065, hold=0, decay=718.4, sustain=0.4092, release=95, ampCurve=0.8721, click=0.4686, clickTone=6094.3396, clickDecay=3, punch=0.3642, tone=8127.6596, toneKeytrack=0.16, drive=3.97, driveMode=1, compressor=0.1387, clipper=0.3052, output=-3.84),
            R("Afterdark Weight", "A sustained after-hours trap bass with smooth legato movement.", ["sustained", "legato"], voiceMode=0, legato=True, triggerMode=1, velocitySens=62, tune=0, fine=0, bendRange=12, glide=390, body=0.049, harmonics=0.2127, harmonicBalance=-0.4522, pitchDrop=29.4, pitchDecay=59.0375, pitchCurve=1.9, attack=0.2779, hold=0, decay=1123.4, sustain=0.4406, release=850, ampCurve=0.8541, click=0.4522, clickTone=6216.9811, clickDecay=3, punch=0.3869, tone=8329.7872, toneKeytrack=0.16, drive=12.9, driveMode=1, compressor=0.1604, clipper=0.3239, output=-10.88),
        ]),
        ("Distorted", [
            ...
            R("Burn Notice", "A warm asymmetrical burn with a longer musical tail.", ["warm", "asymmetrical"], voiceMode=0, legato=True, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=105, body=0.4582, harmonics=0.55, harmonicBalance=-0.907, pitchDrop=6.8, pitchDecay=52.8, pitchCurve=0.8, attack=0.1048, hold=0, decay=838.4, sustain=0.0508, release=190, ampCurve=0.7133, click=0.3054, clickTone=4783.0189, clickDecay=3.7, punch=0.0592, tone=5382.9787, toneKeytrack=0.22, drive=24.3, driveMode=2, compressor=0.3092, clipper=0.3588, output=-6.36),
            R("Crushed Chrome", "A bright crushed 808 for maximal high-frequency presence.", ["bright", "crushed"], voiceMode=0, legato=False, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=0, body=0.5666, harmonics=0.6, harmonicBalance=-0.8605, pitchDrop=8.6, pitchDecay=56.2, pitchCurve=0.38, attack=0.1323, hold=0, decay=1687.7, sustain=0.0763, release=55, ampCurve=0.3689, click=0.3181, clickTone=4924.5283, clickDecay=1.2, punch=0.0834, tone=5574.4681, toneKeytrack=0.22, drive=28.2, driveMode=3, compressor=0.3192, clipper=0.3602, output=-5.19),
            ...
            R("Rusted Crown", "A tube-scorched 808 with a thick controlled midrange.", ["tube", "thick"], voiceMode=0, legato=True, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=150, body=0.7833, harmonics=0.8054, harmonicBalance=-0.7674, pitchDrop=12.2, pitchDecay=63.1, pitchCurve=0.8, attack=0.1871, hold=0, decay=1475.4, sustain=0.1271, release=360, ampCurve=0.7822, click=0.3435, clickTone=5207.5472, clickDecay=3.7, punch=0.1316, tone=5957.4468, toneKeytrack=0.22, drive=17.2, driveMode=1, compressor=0.4032, clipper=0.3605, output=-8.88),
            ...
            R("Voltage Scar", "A short voltage spike with a clean sub beneath the damage.", ["short", "layered"], voiceMode=0, legato=False, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=0, body=0.257, harmonics=0.8, harmonicBalance=-0.6744, pitchDrop=15.9, pitchDecay=69.9, pitchCurve=0.44, attack=0.2419, hold=0, decay=1900, sustain=0.1779, release=62, ampCurve=0.6444, click=0.3689, clickTone=5490.566, clickDecay=3.7, punch=0.1799, tone=6340.4255, toneKeytrack=0.22, drive=25.1, driveMode=3, compressor=0.3595, clipper=0.3659, output=-7.34),
            ...
            R("Iron Lung", "A dark breathing distortion with a very long gated tail.", ["dark", "gated"], voiceMode=0, legato=True, triggerMode=1, velocitySens=55, tune=0, fine=0, bendRange=12, glide=405, body=0.5821, harmonics=0.95, harmonicBalance=-0.5349, pitchDrop=10.87, pitchDecay=80.1, pitchCurve=2.4, attack=0.3242, hold=0, decay=944.6, sustain=0.0359, release=920, ampCurve=0.5296, click=0.407, clickTone=5915.0943, clickDecay=3.7, punch=0.2522, tone=6914.8936, toneKeytrack=0.22, drive=18, driveMode=1, compressor=0.3898, clipper=0.371, output=-9.16),
            ...
            R("Circuit Bruise", "A bruised soft-clip tone with heavy even-harmonic bloom.", ["soft-clip", "even-harmonic"], voiceMode=0, legato=False, triggerMode=0, velocitySens=55, tune=0, fine=0, bendRange=12, glide=0, body=0.7988, harmonics=0.5045, harmonicBalance=-0.4419, pitchDrop=24.9, pitchDecay=87, pitchCurve=0.8, attack=0.379, hold=0, decay=732.2, sustain=0.3051, release=330, ampCurve=0.3919, click=0.4324, clickTone=6198.1132, clickDecay=3.7, punch=0.3005, tone=7297.8723, toneKeytrack=0.22, drive=25.8, driveMode=2, compressor=0.4099, clipper=0.3729, output=-7.21),
        ...
        ("Drill", [
            ...
            R("Sliding Shadow", "A deep long drill slide that moves without losing pitch center.", ["deep", "long-slide"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=425, body=0.1359, harmonics=0.1218, harmonicBalance=-0.9151, pitchDrop=19.71, pitchDecay=57.1052, pitchCurve=1.6, attack=0.2355, hold=0, decay=1837.2, sustain=0.2955, release=380, ampCurve=0.8912, click=0.3315, clickTone=5211.1448, clickDecay=3.8, punch=0.0477, tone=5922.5078, toneKeytrack=0.22, drive=2.65, driveMode=1, compressor=0.1243, clipper=0.0796, output=-3.45),
            ...
            R("Concrete Freeze", "An ultra-low sustained drill foundation for sparse piano loops.", ["sustained", "ultra-low"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=365, body=0.2717, harmonics=0.1836, harmonicBalance=-0.8802, pitchDrop=19.17, pitchDecay=73.2132, pitchCurve=1.9, attack=0.3914, hold=0, decay=1566.5, sustain=0.1532, release=520, ampCurve=0.7801, click=0.2581, clickTone=4452.8302, clickDecay=3.8, punch=0.0953, tone=5223.4043, toneKeytrack=0.22, drive=13.56, driveMode=1, compressor=0.3316, clipper=0.0701, output=-2.83),
            R("Dark March", "A gritty marching drill bass with an assertive upper edge.", ["gritty", "mid-forward"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=255, body=0.3396, harmonics=0.298, harmonicBalance=-0.8413, pitchDrop=15.61, pitchDecay=49.0789, pitchCurve=1.05, attack=0.1578, hold=0, decay=1865.7, sustain=0.1801, release=155, ampCurve=0.8689, click=0.2657, clickTone=5367.7778, clickDecay=3.8, punch=0.0365, tone=6258.1181, toneKeytrack=0.22, drive=0.7, driveMode=2, compressor=0.1015, clipper=0.0855, output=-3.49),
            R("Grit Slide", "A saturated drill slide with audible movement on small speakers.", ["saturated", "speaker-ready"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=325, body=0.2021, harmonics=0.2578, harmonicBalance=-0.8453, pitchDrop=15.33, pitchDecay=54.9316, pitchCurve=1.05, attack=0.2144, hold=0, decay=900, sustain=0.1725, release=270, ampCurve=0.5067, click=0.3226, clickTone=5162.1469, clickDecay=3.8, punch=0.143, tone=5585.1064, toneKeytrack=0.22, drive=4.1, driveMode=3, compressor=0.3752, clipper=0.0812, output=-0.43),
            R("Tension Wire", "A resonant slow-bending 808 that builds suspense between notes.", ["resonant", "slow-bend"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=505, body=0.0097, harmonics=0.2452, harmonicBalance=-0.8279, pitchDrop=14.4, pitchDecay=65.8, pitchCurve=2.3, attack=0.2419, hold=0, decay=2300, sustain=0.2457, release=720, ampCurve=0.7178, click=0.3014, clickTone=4792.4528, clickDecay=3.8, punch=0.1668, tone=5765.9574, toneKeytrack=0.22, drive=7.5, driveMode=2, compressor=0.3605, clipper=0.0918, output=-4.9),
            R("Alley Phantom", "A nearly pure phantom sub with an extra-long legato tail.", ["pure", "phantom"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=610, body=0.0776, harmonics=0.3073, harmonicBalance=-0.8105, pitchDrop=15.6, pitchDecay=68.6, pitchCurve=1.05, attack=0.2694, hold=0, decay=2170.4, sustain=0.1725, release=840, ampCurve=0.9444, click=0.313, clickTone=5026.2978, clickDecay=3.8, punch=0.1906, tone=5627.2114, toneKeytrack=0.22, drive=10.9, driveMode=1, compressor=0.3463, clipper=0.0812, output=-4.6),
            R("Black Puffer", "A compact hard drill knock with rapid pitch settling.", ["compact", "knock"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=92, body=0.1456, harmonics=0.3382, harmonicBalance=-0.793, pitchDrop=7.56, pitchDecay=58.3316, pitchCurve=0.42, attack=0.2968, hold=0, decay=1757.1, sustain=0.3756, release=68, ampCurve=0.3652, click=0.3246, clickTone=5018.8679, clickDecay=3.8, punch=0.2145, tone=6127.6596, toneKeytrack=0.22, drive=14.2, driveMode=2, compressor=0.3125, clipper=0.1029, output=-5.92),
            R("Winter Pressure", "A balanced winter-dark slide suitable for full drill arrangements.", ["balanced", "dark"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=282, body=0.2135, harmonics=0.235, harmonicBalance=-0.7756, pitchDrop=13.98, pitchDecay=72.8789, pitchCurve=1.75, attack=0.3882, hold=0, decay=2222, sustain=0.3511, release=330, ampCurve=0.4697, click=0.3362, clickTone=5132.0755, clickDecay=3.8, punch=0.2383, tone=6308.5106, toneKeytrack=0.22, drive=6.32, driveMode=2, compressor=0.3285, clipper=0.0678, output=-0.9),
            R("Steel Slide", "A bright steel-edged drill glide for fast octave movement.", ["bright", "octave-slide"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=205, body=0.2609, harmonics=0.0628, harmonicBalance=-0.7581, pitchDrop=19.4, pitchDecay=77.1, pitchCurve=1.05, attack=0.3516, hold=0, decay=1682.2, sustain=0.3862, release=180, ampCurve=0.4488, click=0.3478, clickTone=4556.3986, clickDecay=3.8, punch=0.2621, tone=6489.3617, toneKeytrack=0.38, drive=5.83, driveMode=2, compressor=0.3662, clipper=0.2598, output=-7.67),
            R("North Wind", "A smooth cold glide with softened transients and a long release.", ["smooth", "soft-transient"], voiceMode=0, legato=True, triggerMode=1, velocitySens=56, tune=0, fine=0, bendRange=12, glide=470, body=0.3493, harmonics=0.0937, harmonicBalance=-0.7407, pitchDrop=20.6, pitchDecay=79.9, pitchCurve=2, attack=0.379, hold=0, decay=1105.6, sustain=0.4213, release=950, ampCurve=0.4407, click=0.3595, clickTone=5358.4906, clickDecay=3.8, punch=0.286, tone=6670.2128, toneKeytrack=0.22, drive=8.2, driveMode=2, compressor=0.3931, clipper=0.2799, output=-8.4),
        ...
        ("Detroit", [
            ...
            R("Buffed Up", "An extremely tight bright knock with hard clipping.", ["tight", "bright"], voiceMode=0, legato=False, triggerMode=0, velocitySens=72, tune=0, fine=0, bendRange=12, glide=0, body=0.2403, harmonics=0.1941, harmonicBalance=-0.8301, pitchDrop=10.6, pitchDecay=49.1, pitchCurve=0.34, attack=0.1323, hold=0, decay=820, sustain=0.0145, release=34, ampCurve=0.3467, click=0.3905, clickTone=5339.6226, clickDecay=1, punch=0.3605, tone=7106.383, toneKeytrack=0.18, drive=11.6, driveMode=3, compressor=0.3554, clipper=0.4706, output=-6.84),
        ...
        ("West Coast", [
            R("Palm Bounce", "A warm round coastal 808 with an easy medium glide.", ["round", "easy-glide"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=122, body=0.1336, harmonics=0.1484, harmonicBalance=0.4189, pitchDrop=6.15, pitchDecay=65.2874, pitchCurve=1.3, attack=0.4823, hold=0, decay=2821.9732, sustain=0.3223, release=390, ampCurve=0.9518, click=0.1506, clickTone=3869.4199, clickDecay=4.5, punch=0.1625, tone=3349.9972, toneKeytrack=0.26, drive=1.99, driveMode=1, compressor=0.2572, clipper=0.1981, output=-5.53),
            R("Chrome Coast", "A polished upper-harmonic coast bass with chrome definition.", ["polished", "defined"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=82, body=0.0881, harmonics=0.2388, harmonicBalance=0.2826, pitchDrop=3.2, pitchDecay=57.332, pitchCurve=1.3, attack=0.4097, hold=0, decay=1487.2, sustain=0.0722, release=230, ampCurve=0.6346, click=0.1595, clickTone=4036.8154, clickDecay=4.5, punch=0.0398, tone=3340.4255, toneKeytrack=0.26, drive=9.33, driveMode=1, compressor=0.2265, clipper=0.2, output=-3.38),
            R("Lowrider Lean", "A slow leaning long-tail 808 for spacious west-coast drums.", ["slow", "long-tail"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=345, body=0.1612, harmonics=0.4177, harmonicBalance=0.3223, pitchDrop=6.68, pitchDecay=69.4529, pitchCurve=2, attack=0.4832, hold=0, decay=2884.2, sustain=0.2669, release=820, ampCurve=0.9968, click=0.2326, clickTone=4074.2443, clickDecay=4.5, punch=0.0414, tone=4496.2115, toneKeytrack=0.26, drive=2.73, driveMode=1, compressor=0.2484, clipper=0.2319, output=-8.21),
            R("Sunset Trunk", "A soft sunset trunk tone with a smooth musical release.", ["soft", "musical"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=265, body=0.2833, harmonics=0.3552, harmonicBalance=0.3018, pitchDrop=6.73, pitchDecay=59.4532, pitchCurve=1.55, attack=0.414, hold=0, decay=1428.551, sustain=0.0576, release=620, ampCurve=0.7016, click=0.2168, clickTone=3776.5374, clickDecay=4.5, punch=0.1843, tone=3843.1335, toneKeytrack=0.26, drive=6.04, driveMode=1, compressor=0.3485, clipper=0.1794, output=-2.6),
            R("G-Funk Floor", "A harmonically rich tonal 808 suited to melodic funk basslines.", ["tonal", "funk"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=182, body=0.3347, harmonics=0.2591, harmonicBalance=0.3931, pitchDrop=6.13, pitchDecay=69.3564, pitchCurve=1.3, attack=0.4677, hold=0, decay=2578, sustain=0.3602, release=470, ampCurve=1.0156, click=0.2383, clickTone=3471.6981, clickDecay=4.5, punch=0.0522, tone=4938.211, toneKeytrack=0.48, drive=1.1, driveMode=1, compressor=0.2702, clipper=0.2045, output=-5.91),
            ...
            R("Boulevard Bass", "A pure boulevard sub that glides beneath busy instrumentation.", ["pure", "under-mix"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=425, body=0.0305, harmonics=0.1819, harmonicBalance=0.4216, pitchDrop=12.21, pitchDecay=81.84, pitchCurve=2.3, attack=0.4906, hold=0, decay=1275.3, sustain=0.2396, release=980, ampCurve=0.6566, click=0.1543, clickTone=3584.8132, clickDecay=4.5, punch=0.2384, tone=3353.017, toneKeytrack=0.26, drive=5.8, driveMode=1, compressor=0.2889, clipper=0.1679, output=-2.6),
            R("Coastline Smoke", "A dark smoky legato tone with a soft tube edge.", ["smoky", "tube"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=305, body=0.0582, harmonics=0.2101, harmonicBalance=0.3311, pitchDrop=6.6, pitchDecay=66.5029, pitchCurve=1.3, attack=0.4437, hold=0, decay=1200, sustain=0.0537, release=1050, ampCurve=0.5242, click=0.2178, clickTone=3907.5391, clickDecay=4.5, punch=0.0434, tone=4178.021, toneKeytrack=0.26, drive=4.17, driveMode=1, compressor=0.3007, clipper=0.2101, output=-2.04),
            R("Coast Chrome", "A bright modern coast 808 with wide upper-harmonic character.", ["bright", "modern"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=112, body=0.2973, harmonics=0.3864, harmonicBalance=0.3965, pitchDrop=12.2, pitchDecay=73.6, pitchCurve=1.3, attack=0.4635, hold=0, decay=2156.1, sustain=0.16, release=330, ampCurve=0.6759, click=0.2276, clickTone=3347.8292, clickDecay=4.5, punch=0.1791, tone=3185.5734, toneKeytrack=0.4, drive=6.89, driveMode=2, compressor=0.3316, clipper=0.1707, output=-6.43),
            R("Sunday Cruise", "A relaxed cruising 808 with a gentle pitch envelope.", ["relaxed", "gentle"], voiceMode=0, legato=True, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=225, body=0.2174, harmonics=0.4182, harmonicBalance=0.4128, pitchDrop=13.3, pitchDecay=72.2577, pitchCurve=2.1, attack=0.497, hold=0, decay=1812.4, sustain=0.1942, release=780, ampCurve=0.7141, click=0.1594, clickTone=3943.3962, clickDecay=4.5, punch=0.199, tone=4702.1277, toneKeytrack=0.26, drive=1.6, driveMode=1, compressor=0.3433, clipper=0.1765, output=-4.48),
            R("Daylight Rider", "A clean daylight bass with extra melodic key tracking.", ["clean", "melodic"], voiceMode=1, legato=False, triggerMode=1, velocitySens=50, tune=0, fine=0, bendRange=12, glide=0, body=0.0451, harmonics=0.1962, harmonicBalance=0.445, pitchDrop=14.4, pitchDecay=79.8, pitchCurve=1.3, attack=0.4686, hold=0, decay=1924.6042, sustain=0.3969, release=540, ampCurve=0.5168, click=0.246, clickTone=3485.9715, clickDecay=4.5, punch=0.0666, tone=4957.3215, toneKeytrack=0.62, drive=4.17, driveMode=1, compressor=0.2949, clipper=0.2, output=-0.24),
            R("Golden State Knock", "A firm west-coast knock with warm saturation and short glide.", ["firm", "warm"], voiceMode=0, legato=True, triggerMode=0, velocitySens=50, tune=0, fine=0, bendRange=12, glide=68, body=0.042, harmonics=0.1932, harmonicBalance=0.4453, pitchDrop=15.6, pitchDecay=82.0904, pitchCurve=1.3, attack=0.416, hold=0, decay=1395.8, sustain=0.4329, release=130, ampCurve=0.6507, click=0.1978, clickTone=3989.1854, clickDecay=4.5, punch=0.2388, tone=5042.5532, toneKeytrack=0.26, drive=8.07, driveMode=1, compressor=0.3565, clipper=0.2, output=-3.61),
        ]),
        ("Long Glide", [
            R("Endless Bend", "An extremely long clean bend with an almost continuous tail.", ["extreme-glide", "clean"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=720, body=0.0639, harmonics=0.0585, harmonicBalance=-0.9546, pitchDrop=9.5, pitchDecay=84.48, pitchCurve=1.45, attack=0.4583, hold=0, decay=3602.3, sustain=0.7559, release=1250, ampCurve=0.9267, click=0.0465, clickTone=2084.9057, clickDecay=5.5, punch=0.0118, tone=1638.2979, toneKeytrack=0.28, drive=3, driveMode=1, compressor=0.0535, clipper=0.0453, output=-5.03),
            R("Silk Slide", "A smooth silky legato slide with soft even harmonics.", ["smooth", "even-harmonic"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=525, body=0.155, harmonics=0.1946, harmonicBalance=-0.9093, pitchDrop=11.6, pitchDecay=73.8333, pitchCurve=1.45, attack=0.398, hold=0, decay=2801, sustain=0.7019, release=980, ampCurve=1.4318, click=0.1177, clickTone=2169.8113, clickDecay=5.5, punch=0.0236, tone=1776.5957, toneKeytrack=0.28, drive=2.45, driveMode=1, compressor=0.1082, clipper=0.0162, output=-4.67),
            R("Lunar Portamento", "A wide tonal portamento preset for dramatic octave jumps.", ["portamento", "octave"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=920, body=0.1916, harmonics=0.1756, harmonicBalance=-0.9096, pitchDrop=15.94, pitchDecay=87.3742, pitchCurve=2.4, attack=0.2464, hold=0, decay=4403.6, sustain=0.667, release=1500, ampCurve=0.6956, click=0.0658, clickTone=2254.717, clickDecay=5.5, punch=0.1225, tone=1914.8936, toneKeytrack=0.55, drive=9, driveMode=2, compressor=0.1407, clipper=0.0121, output=-7.77),
            R("Slow Lane", "A pure slow-lane sub with understated note transitions.", ["pure", "understated"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=625, body=0.274, harmonics=0.5532, harmonicBalance=-0.8147, pitchDrop=11.64, pitchDecay=90.8646, pitchCurve=1.9, attack=0.2773, hold=0, decay=3429.6, sustain=0.7019, release=1150, ampCurve=1.2459, click=0.0659, clickTone=2305.3843, clickDecay=5.5, punch=0.0175, tone=2423.8969, toneKeytrack=0.28, drive=6.27, driveMode=1, compressor=0.07, clipper=0.0325, output=-5.46),
            R("Deep Curve", "A dark curved glide with enough harmonics to remain audible.", ["dark", "audible"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=465, body=0.3193, harmonics=0.3686, harmonicBalance=-0.7731, pitchDrop=2.08, pitchDecay=56.3866, pitchCurve=1.45, attack=0.2959, hold=0, decay=2694.4, sustain=0.667, release=820, ampCurve=0.9961, click=0.0866, clickTone=2424.5283, clickDecay=5.5, punch=0.0235, tone=2191.4894, toneKeytrack=0.28, drive=8.55, driveMode=1, compressor=0.131, clipper=0.0121, output=-3.44),
            ...
            R("Ghost Glide", "A nearly invisible fundamental-only glide for layering.", ["fundamental", "layering"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=860, body=0.2954, harmonics=0.089, harmonicBalance=-0.6824, pitchDrop=1.53, pitchDecay=64.8133, pitchCurve=1, attack=0.3469, hold=0, decay=3690, sustain=0.7845, release=1600, ampCurve=1.3345, click=0.0854, clickTone=2594.3396, clickDecay=5.5, punch=0.0825, tone=2468.0851, toneKeytrack=0.28, drive=1.13, driveMode=1, compressor=0.0751, clipper=0.056, output=-5.99),
            R("Late Arrival", "A delayed-feeling pitch fall followed by a medium-long glide.", ["delayed-pitch", "medium-glide"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=385, body=0.073, harmonics=0.4684, harmonicBalance=-0.7648, pitchDrop=7.96, pitchDecay=79.97, pitchCurve=1.8, attack=0.2388, hold=0, decay=2200, sustain=0.6455, release=740, ampCurve=1.5044, click=0.0698, clickTone=2169.1209, clickDecay=5.5, punch=0.0847, tone=2937.6231, toneKeytrack=0.28, drive=9.6, driveMode=1, compressor=0.118, clipper=0.0649, output=-6.58),
            R("Infinite Trunk", "A massive sustained trunk note with reliable mono legato behavior.", ["massive", "trunk"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=645, body=0.1368, harmonics=0.5269, harmonicBalance=-0.674, pitchDrop=12.6, pitchDecay=63.1867, pitchCurve=2.2, attack=0.3377, hold=0, decay=3310, sustain=0.77, release=1800, ampCurve=0.6185, click=0.0529, clickTone=2262.5172, clickDecay=5.5, punch=0.0541, tone=3089.7509, toneKeytrack=0.28, drive=12.6, driveMode=1, compressor=0.13, clipper=0.0731, output=-8.52),
            R("Afterhours Drift", "A harmonically rich after-hours drift with a relaxed release.", ["rich", "relaxed"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=565, body=0.2315, harmonics=0.5855, harmonicBalance=-0.5463, pitchDrop=14, pitchDecay=58.6767, pitchCurve=1.45, attack=0.3121, hold=0, decay=4800, sustain=0.793, release=1100, ampCurve=0.787, click=0.0937, clickTone=2796.8706, clickDecay=5.5, punch=0.1178, tone=2882.9787, toneKeytrack=0.28, drive=5.71, driveMode=2, compressor=0.142, clipper=0.0812, output=-7.89),
            R("Long Game", "A practical long glide tuned for sustained modern bass melodies.", ["practical", "bass-melody"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=440, body=0.2741, harmonics=0.0414, harmonicBalance=-0.6969, pitchDrop=15.4, pitchDecay=84.2559, pitchCurve=1.45, attack=0.4486, hold=0, decay=4044.3, sustain=0.7908, release=920, ampCurve=1.455, click=0.0601, clickTone=2933.9623, clickDecay=5.5, punch=0.0481, tone=3021.2766, toneKeytrack=0.42, drive=2.76, driveMode=1, compressor=0.0662, clipper=0.0583, output=-7.31),
            R("Gravity Lane", "A heavy downward glide with a pronounced opening pitch drop.", ["heavy", "downward"], voiceMode=0, legato=True, triggerMode=1, velocitySens=46, tune=0, fine=0, bendRange=24, glide=690, body=0.0631, harmonics=0.226, harmonicBalance=-0.4555, pitchDrop=16.8, pitchDecay=95.2, pitchCurve=1.65, attack=0.4587, hold=0, decay=2600.6, sustain=0.839, release=1300, ampCurve=0.9961, click=0.1178, clickTone=3018.8679, clickDecay=5.5, punch=0.1414, tone=3159.5745, toneKeytrack=0.28, drive=8.55, driveMode=1, compressor=0.1154, clipper=0.0974, output=-8.82),
        ]),
        ("Short Punch", [
        ...
        ("Experimental", [
            ...
            R("Radioactive Sub", "A radioactive resonant sub with slow attack and unstable color.", ["radioactive", "resonant"], voiceMode=0, legato=True, triggerMode=1, velocitySens=64, tune=0, fine=0, bendRange=24, glide=760, body=0.3061, harmonics=0.862, harmonicBalance=-0.5814, pitchDrop=18.8, pitchDecay=200.7, pitchCurve=3.5, attack=0.2968, hold=20, decay=2661.5, sustain=0.4576, release=1180, ampCurve=0.3233, click=0.2459, clickTone=4113.2075, clickDecay=8, punch=0.2195, tone=4702.1277, toneKeytrack=0.82, drive=32, driveMode=3, compressor=0.4132, clipper=0.5094, output=-6.05),
            R("Reverse Gravity", "A slow-settling pitch illusion with maximal expressive glide.", ["pitch-illusion", "expressive"], voiceMode=0, legato=True, triggerMode=1, velocitySens=64, tune=0, fine=0, bendRange=24, glide=1250, body=0.449, harmonics=0.931, harmonicBalance=-0.5349, pitchDrop=20.9, pitchDecay=214.7, pitchCurve=4, attack=0.3242, hold=80, decay=1430.8, sustain=0.5084, release=1050, ampCurve=0.7133, click=0.2622, clickTone=4292.4528, clickDecay=14, punch=0.2439, tone=4946.8085, toneKeytrack=0.55, drive=12.7, driveMode=2, compressor=0.4149, clipper=0.4932, output=-12.78),
        ...
        ("Mix Ready", [
            ...
            R("Master Bus Safe", "A conservative clean sub with ample mastering headroom.", ["headroom", "clean"], voiceMode=0, legato=False, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=0, body=0.2052, harmonics=0.3508, harmonicBalance=0.0434, pitchDrop=17.24, pitchDecay=59.685, pitchCurve=0.95, attack=0.2202, hold=0, decay=949.2, sustain=0.0542, release=250, ampCurve=0.4267, click=0.2283, clickTone=3756.9026, clickDecay=3, punch=0.1445, tone=5605.887, toneKeytrack=0.14, drive=4.45, driveMode=0, compressor=0.0969, clipper=0.0671, output=0.91),
            ...
            R("Streaming Low", "A compact level-controlled low end prepared for streaming masters.", ["streaming", "level-controlled"], voiceMode=0, legato=False, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=0, body=0.2458, harmonics=0.0854, harmonicBalance=0.115, pitchDrop=11.9, pitchDecay=58.345, pitchCurve=0.95, attack=0.1551, hold=0, decay=1284, sustain=0.0666, release=145, ampCurve=0.9467, click=0.344, clickTone=5143.3339, clickDecay=3, punch=0.1238, tone=6091.4275, toneKeytrack=0.14, drive=5.85, driveMode=2, compressor=0.2342, clipper=0.2143, output=-4.11),
            R("Tight Master", "A tight clipped body that stays disciplined under bus limiting.", ["tight", "limiter-safe"], voiceMode=0, legato=False, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=0, body=0.1774, harmonics=0.3194, harmonicBalance=0.276, pitchDrop=12.6, pitchDecay=51.4, pitchCurve=0.66, attack=0.2286, hold=0, decay=694.1, sustain=0.0799, release=88, ampCurve=0.5857, click=0.2966, clickTone=4122.6415, clickDecay=3, punch=0.2861, tone=5021.2766, toneKeytrack=0.14, drive=3.79, driveMode=3, compressor=0.3334, clipper=0.1341, output=-1.85),
            ...
            R("Sidechain Space", "A shorter release 808 designed to recover cleanly after ducking.", ["sidechain", "short-release"], voiceMode=0, legato=True, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=122, body=0.0467, harmonics=0.2024, harmonicBalance=0.1736, pitchDrop=15.39, pitchDecay=57.5982, pitchCurve=0.95, attack=0.3249, hold=0, decay=1417.3835, sustain=0.0698, release=95, ampCurve=0.4564, click=0.3419, clickTone=4672.6173, clickDecay=3, punch=0.2178, tone=6489.031, toneKeytrack=0.14, drive=2.28, driveMode=1, compressor=0.3171, clipper=0.0353, output=-1.54),
            ...
            R("Ready Print", "A finished assertive 808 requiring minimal additional processing.", ["finished", "assertive"], voiceMode=0, legato=True, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=62, body=0.1467, harmonics=0.3514, harmonicBalance=0.1464, pitchDrop=9.23, pitchDecay=50.6566, pitchCurve=0.58, attack=0.336, hold=0, decay=1092.9, sustain=0.1748, release=78, ampCurve=0.8394, click=0.3081, clickTone=4537.7358, clickDecay=3, punch=0.2502, tone=5702.1277, toneKeytrack=0.14, drive=7.67, driveMode=2, compressor=0.3231, clipper=0.2235, output=-5.17),
            R("Vocal Gap", "A scooped low-mid 808 with smooth sustain beneath dense vocals.", ["scooped", "vocal-space"], voiceMode=0, legato=True, triggerMode=1, velocitySens=58, tune=0, fine=0, bendRange=12, glide=155, body=0.0653, harmonics=0.0032, harmonicBalance=0.1715, pitchDrop=16.6, pitchDecay=55.9, pitchCurve=0.95, attack=0.3629, hold=0, decay=656.0752, sustain=0.1465, release=360, ampCurve=0.8089, click=0.3189, clickTone=4901.8731, clickDecay=3, punch=0.2673, tone=5677.0297, toneKeytrack=0.14, drive=7.32, driveMode=1, compressor=0.3554, clipper=0.2459, output=-6.91),
            ...
            R("Centered Low", "A solid centered body with restrained transient and medium decay.", ["centered", "restrained"], voiceMode=0, legato=False, triggerMode=0, velocitySens=58, tune=0, fine=0, bendRange=12, glide=0, body=0.0778, harmonics=0.1437, harmonicBalance=0.2719, pitchDrop=18.94, pitchDecay=48.9271, pitchCurve=0.95, attack=0.4965, hold=0, decay=771.1528, sustain=0.1203, release=170, ampCurve=0.6456, click=0.3622, clickTone=5092.0952, clickDecay=3, punch=0.3358, tone=6003.4911, toneKeytrack=0.14, drive=1.1, driveMode=1, compressor=0.3708, clipper=0.0381, output=0.53),
